...
class FichePayeParser(models.AbstractModel):
    _name = 'report.hr_payroll_report.report_payslip_monthly'
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('hr_payroll_report.report_payslip_monthly', docargs)
