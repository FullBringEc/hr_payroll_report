...
class ReportCstParser(models.AbstractModel):
    _name = 'report.hr_payroll_report.report_cst_4010_a_monthly'
    ...
    def format_date(self, d, f):
        d1 = datetime.datetime.strptime(d, '%Y-%m-%d')
        return d1.strftime(f)
    ...
    def split_docs_by_number(self, docs, num=5):
         ...
         i = 0
         c = 0
         #Réserver de la place pour la colonne Rubriques et Total
         num -= 2
         for o in docs:
             if i == num:
                 res.append(temp)
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('hr_payroll_report.report_cst_4010_a_monthly', docargs)
